...
// Valid time units.
var UNITS = ["now", "second", "minute", "hour", "day", "week", "month", "quarter", "year"];
...
"long_time", "long_convenient", "short_time", "short_convenient", "tiny"];
...
var RelativeTimeFormat = function () {
  _createClass(RelativeTimeFormat, null, [{
    key: "useVersion",
     ...
     */
    value: function useVersion(preferredVersion) {
